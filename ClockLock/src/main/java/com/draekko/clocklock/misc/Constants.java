...
public class Constants {
    ...
    public static final String USE_DEBUGGER = "USE_DEBUGGER";

    public static final String PREF_NAME = "ClockLock";
    ...
    public static final String WEATHER_USE_SENSORS = "weather_use_sensors";
    ...
    public static final String CALENDAR_SEPARATOR="calendar_separator";
    ...
    public static final String CALENDAR_BACKGROUND_COLOR = "calendar_background_color";
    ...
    // Intent actions
    public static final String ACTION_SHOW_FORECAST = "com.draekko.clocklock.action.SHOW_FORECAST";
    ...
    public static final float LOCATION_ACCURACY_THRESHOLD_METERS = 50000;
}
