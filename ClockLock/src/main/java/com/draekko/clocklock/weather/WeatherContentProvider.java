...
public class WeatherContentProvider extends ContentProvider {
    ...
    private static final String COLUMN_CURRENT_STATE = "state";
    private static final String COLUMN_CURRENT_COUNTRY = "country";
    ...
    private static final String[] PROJECTION_DEFAULT_CURRENT = new String[] {
            ...
            COLUMN_CURRENT_CITY,
            COLUMN_CURRENT_STATE,
            COLUMN_CURRENT_COUNTRY,
    ...
    public static final String AUTHORITY = "com.draekko.clocklock.weather.provider";
    ...
    public Cursor query(
        ...
        if (weather != null) {
            ...
            result.newRow()
                    ...
                    .add(COLUMN_CURRENT_STATE, weather.getState())
                    .add(COLUMN_CURRENT_COUNTRY, weather.getCountry())
    ...
    public static void updateCachedWeatherInfo(Context context, WeatherInfo info) {
        ...
        if(info != null) {
            ...
            String weather_data = info.toSerializedString();
            sCachedWeatherInfo = WeatherInfo.fromSerializedString(context, weather_data);
