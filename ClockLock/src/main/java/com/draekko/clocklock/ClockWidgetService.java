...
public class ClockWidgetService extends IntentService {
    ...
    private void refreshWidget() {
        ...
        for (int id : mWidgetIds) {
            ...
            remoteViews.setViewVisibility(R.id.weather_panel, vis2);
    ...
    private void resetWeather(boolean forceRefresh) {
        PendingIntent pi = null;
        if (forceRefresh) {
            pi = WeatherUpdateService.getUpdateIntent(this, true);
        }
        ...
        WeatherUpdateService.scheduleUpdate(getApplicationContext(), 0, true);
    }
