...
import com.draekko.clocklock.weather.WeatherProvider.LocationResult;

import java.util.HashSet;
import java.util.List;

public class CustomLocationPreference extends TrayEditTextPreference {
    ...
    private class WeatherLocationTask extends AsyncTask<Void, Void, List<LocationResult>> {
        ...
        protected List<LocationResult> doInBackground(Void... input) {
            WeatherProvider weatherProvider = Preferences.weatherProvider(getContext());
            if (weatherProvider == null) {
                return null;
            }
            return weatherProvider.getLocations(mLocation);
        }
