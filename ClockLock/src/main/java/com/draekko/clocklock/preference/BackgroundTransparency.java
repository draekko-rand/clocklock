...
import com.draekko.traypreferences.TrayDialogPreference;
 ...
 */
public class BackgroundTransparency extends TrayDialogPreference {
    ...
    protected void onBindDialogView(View view) {
        ...
        //TraySharedPreferences getPrefs = mContext.getSharedPreferences(Constants.PREF_NAME, Context.MODE_PRIVATE);
        mOriginalBackgroundTransparency = getPrefs(mContext).getInt(Constants.CLOCK_BACKGROUND_TRANSPARENCY,
